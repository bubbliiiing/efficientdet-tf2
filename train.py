...
if __name__ == "__main__":
    ...
    #   （一）从整个模型的预训练权重开始训练： 
    #       Adam：
    #           Init_Epoch = 0，Freeze_Epoch = 50，UnFreeze_Epoch = 100，Freeze_Train = True，optimizer_type = 'adam'，Init_lr = 3e-4。（冻结）
    #           Init_Epoch = 0，UnFreeze_Epoch = 100，Freeze_Train = False，optimizer_type = 'adam'，Init_lr = 3e-4。（不冻结）
    #       SGD：
    ...
    if True:
        ...
        if eager:
            ...
            for epoch in range(start_epoch, end_epoch):
                ...
                fit_one_epoch(model, focal(), smooth_l1(), loss_history, eval_callback, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, 
